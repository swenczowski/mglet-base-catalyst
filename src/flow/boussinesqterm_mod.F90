...
CONTAINS
    ...
    SUBROUTINE init_boussinesqterm()
        ...
        ! TODO: definition of direction/sign for gravity
        ...
        ! TODO: Depending on the order of initialization of flow and scalars,
        ! one could potentially check for the presence of field 'scaname'
        ! here.
    ...
    SUBROUTINE boussinesqterm(uo_f, vo_f, wo_f)
        ...
        CALL get_field(scafield, scaname)
