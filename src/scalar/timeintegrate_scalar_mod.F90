...
CONTAINS
    SUBROUTINE timeintegrate_scalar(itstep, ittot, timeph, dt, irk, rkscheme)
        ...
        DO l = 1, nsca
            ...
            CALL get_field(dt_f, fieldname)

            ! TODO: GC immersed boundary stencils + connect
            ...
            ! TODO: GC immersed boundary stencils
        END DO
